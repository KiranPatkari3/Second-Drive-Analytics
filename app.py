...
def about_page():
    ...
    # st.title("Team Members")
        ...
        team_members = [
            {"name": "Shivani Mahajan", "designation": "EDA and Model Team"},
            {"name": "Neha Baviskar", "designation": "EDA Team and Model Team"},
            {"name": "Kiran Patkari", "designation": "Streamlit Team & Documentation Head"},
            {"name": "Harshal Mahajan", "designation": "Streamlit Team & Documentation Head"},
            {"name": "Jagruti Dhangar", "designation": "Data Cleaning  "},
